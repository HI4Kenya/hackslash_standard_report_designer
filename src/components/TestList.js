...
import JqxListBox from "jqwidgets-framework/jqwidgets-react/react_jqxlistbox.js";
import JqxTextArea from "jqwidgets-framework/jqwidgets-react/react_jqxtextarea.js";
...
class TestList extends React.Component {
  ...
  onDragStart(event) {
    document.getElementById("dragStartLog").innerHTML =
      "Drag Start: " + event.args.label;
  ...
  render() {
    ...
    let dragStart = item => {
      if (item.label == "Breve") return false;
    };
